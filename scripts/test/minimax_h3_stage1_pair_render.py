#!/usr/bin/env python3
"""Render stage-1 classification pairs with MiniMax-H3.

For each sample in a source JSON list, this script creates one output folder
named after the source video stem and writes:

- render.mp4: MiniMax-H3 FL2AV output conditioned on the first GT frame
...
DEFAULT_OUTPUT_DIR = Path("results/minimax_h3_stage1_pairs")
H3_FPS = 24
